...
from . import compute_per_bin_prod_asym
...
def compute_prod_asym(max_iter, kpipi_files, ksk_files, kpipi_weights_file, ksk_weights_file):
...
aprod = compute_prod_asym(max_iter, kpipi_files, ksk_files, kpipi_weights_file, ksk_weights_file)